...
export const vehiclesSeed: Vehicle[] = [
  // ФЛ-резидент (eGov) — легковая + грузовая → 2 карты (как при регистрации с ИИН на «5»)
  { id: 'veh_fl_egov_1', ownerKind: 'user', ownerId: 'user_fl_egov', grnz: '001AAA02', category: 'passenger', active: true },
  { id: 'veh_fl_egov_2', ownerKind: 'user', ownerId: 'user_fl_egov', grnz: '449BBB02', category: 'truck', active: true },
