...
const checks: Check[] = [
  ...
  { label: 'checkMvdRegistry (легковая на пользователе)', run: () => api.checkMvdRegistry('900101300124') },
  { label: 'checkMvdRegistry (нет ТС, есть ОГПО)', run: () => api.checkMvdRegistry('900101300120') },
  { label: 'checkMvdRegistry (ошибка, ИИН на 6)', run: () => api.checkMvdRegistry('900101300126') },
